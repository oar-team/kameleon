    ...
    def do_steps(section_name)
      ...
      section.sequence do |macrostep|
        ...
        macrostep.sequence do |microstep|
              ...
              unless microstep.on_checkpoint == "redo"
                unless checkpointed and @enable_checkpoint == "first-microstep"
                  if checkpoint_enabled?
                    ...
                    Kameleon.ui.info("MicroStep #{microstep.name} checkpoint creation took: #{microstep_checkpoint_duration} secs")
                  end
                end
              end
            end
          ...
          Kameleon.ui.info("MicroStep #{microstep.name} took: #{Time.now.to_i - microstep_time - microstep_checkpoint_duration} secs")
        end
